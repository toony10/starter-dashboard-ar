...
const presetGroups = [
  {
    title: "محايدة",
    description: "أساسيات نظيفة وبسيطة",
    ids: [
      "charcoal",
      "near-black",
      "dark-gray",
  ...
  {
    title: "زرقاء ورمادية",
    description: "أجواء باردة ومركّزة",
    ids: [
      "slate-blue",
      "navy",
      "deep-blue",
  ...
  {
    title: "طبيعية ودافئة",
    description: "ألوان عضوية ومريحة",
    ids: [
      "teal-dark",
      "forest",
      "olive",
...
const cardPresetGroups = [
  {
    title: "أساسية",
    description: "أسطح بطاقات محايدة",
    ids: [
      "default",
      "near-black",
      "carbon",
  ...
  {
    title: "ألوان باردة",
    description: "أسطح بطاقات زرقاء ورمادية",
    ids: [
      "slate",
      "storm",
      "blue-gray",
    ...
    <div className="mx-auto w-full max-w-5xl space-y-8">
        ...
        <section className="rounded-[1.75rem] border bg-card/60 p-5 backdrop-blur-sm sm:p-6">
          <div className="mb-5 space-y-2">
            ...
            <p className="text-sm text-muted-foreground">
              اختياراتك تلوّن واجهة الصفحة والشريط الجانبي وأسطح البطاقات في الوضع الداكن.
            </p>
          </div>
          ...
          <div className="mb-5 space-y-3">
            ...
            <div className="flex items-center gap-3 rounded-2xl border bg-muted/30 p-3">
              ...
              <Button
                ...
                size="icon-sm"
                onClick={ () =>
                  copyHex(selectedBackgroundPreset.value, "لون الخلفية")
                }
                aria-label="نسخ لون الخلفية"
              >
          ...
          <div className="mb-5 space-y-3">
            ...
            <div className="flex items-center gap-3 rounded-2xl border bg-muted/30 p-3">
              ...
              <Button
                ...
                variant="outline"
                size="icon-sm"
                onClick={ () => copyHex(selectedCardColor, "لون البطاقة") }
                aria-label="نسخ لون البطاقة"
              >
                <Copy className="size-3.5" />
              </Button>
            </div>
          ...
          { mounted && !isDark ? (
            <div className="flex items-start gap-3 rounded-2xl border border-dashed border-primary/20 bg-primary/5 p-4">
              ...
              <p className="text-sm text-muted-foreground">
                انتقل إلى الوضع الداكن لرؤية تحديث اللوحة فوراً عبر لوحة التحكم الحقيقية.
              </p>
            </div>
          ) : (
      ...
      <div className="space-y-8">
        <div className="space-y-2">
          ...
          <p className="text-sm text-muted-foreground">
            اختر اللوحة خلف محتوى لوحة التحكم والشريط الجانبي.
          </p>
        </div>
      ...
      <div className="space-y-8">
        <div className="space-y-2">
          ...
          <p className="text-sm text-muted-foreground">
            خصّص أسطح البطاقات في الوضع الداكن. الافتراضي يستخدم القيمة الاحتياطية من globals.css.
          </p>
        </div>
