  ...
  return (
    <>
      ...
      >
        ...
        <kbd className="pointer-events-none absolute end-[0.3rem] top-[0.3rem] hidden h-6 select-none items-center gap-1 rounded border bg-muted px-1.5 font-mono text-[10px] font-medium opacity-100 sm:flex">
