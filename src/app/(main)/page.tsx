...
export default function DashboardPage() {
  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <Button onClick={ () => {
        toast.success("تم النقر على الزر");
      } }>
        انقر هنا
      </Button>
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold" dir="ltr">$45,231.89</div>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold" dir="ltr">+2350</div>
            <p className="text-xs text-muted-foreground">
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold" dir="ltr">+12,234</div>
            <p className="text-xs text-muted-foreground">
              +19% عن الشهر الماضي
            </p>
          </CardContent>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold" dir="ltr">+573</div>
            <p className="text-xs text-muted-foreground">
